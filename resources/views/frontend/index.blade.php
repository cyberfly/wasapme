          ...
          <div class="row">
            <div id="getStarted" ng-controller="MainController" class="banner-info text-center wow fadeIn delay-05s">
              ...
              <div class="brn-btn" style="clear: both;text-align: center;">
                <button type="button" class="btn btn-download">Track now!</button>
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              <div class="item-img">
                <img src="{{ URL::asset('frontend/img/ser01.png') }}">
              </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              <div class="item-img">
                <img src="{{ URL::asset('frontend/img/ser02.png') }}">
              </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              <div class="item-img">
                <img src="{{ URL::asset('frontend/img/ser03.png') }}">
              </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              <div class="item-img">
                <img src="{{ URL::asset('frontend/img/ser04.png') }}">
              </div>
